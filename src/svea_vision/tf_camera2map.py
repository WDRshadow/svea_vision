...
"""
This script is used to transform from the camera coordinate frame to the global map coordincate frame.
Subscribes to /rsu/object_pose to get coordinates of objects from camera and publishes to 
/camera2map node
